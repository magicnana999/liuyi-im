...
@Validated
@RestController
@RequestMapping(value = "/liuyiim/backend/user", produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
public class UserController extends BaseController {
    ...
    public ApiResult createUser(
            @RequestParam("name") String name, @RequestParam(value = "portrait", required = false) String portrait, @RequestParam("outerId") Long outerId) {
