...
import com.creolophus.liuyi.netty.utils.SessionUtil;
...
public abstract class AbstractWebSocketServer {
    ...
    public static void setConfigurableApplicationContext(ConfigurableApplicationContext configurableApplicationContext) {
        ...
        sessionEventListener =
                applicationContext.getBeansOfType(SessionEventListener.class, false, false).size()>0?
                        applicationContext.getBean(SessionEventListener.class):null;
    }
